...
// Vertically scrolling marquee of recent events. Pure CSS animation.
export default function Ticker({ items, title = 'NOW SHOWING' }: Props) {
        ...
        >
          <span
            style={{
              ...
              animation: 'lumiere-pulse 1.4s infinite',
            }}
          />
          {title}
        </div>
        <div style={{ flex: 1, overflow: 'hidden', height: 22, position: 'relative' }}>
          <div
            style={{
              ...
              animation: `lumiere-marquee ${dur}s linear infinite`,
            }}
          >
            {loop.map((e, i) => (
              <div
