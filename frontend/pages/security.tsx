  ...
  return (
    <div style={{ marginBottom: 32 }}>
      ...
      >
        {title}
        {italicTail && (
          <span style={{ fontStyle: 'italic', color: t.accent }}> {italicTail}</span>
        )}
      </h2>
      <p
        style={{
...
const LIFECYCLE: { title: string; body: string }[] = [
  { title: 'Photo uploaded', body: 'EXIF metadata is stripped, the file is stored encrypted, a thumbnail is generated, and a background job queues the photo for face indexing.' },
  { title: 'Faces indexed', body: 'Our self-hosted face recognition engine detects each face in the photo and stores a numerical embedding linked to that photo. The original face crop is not kept.' },
  { title: 'Guest scans', body: 'A guest opens the event link, takes a selfie, and we generate a temporary embedding from that selfie. We compare it to embeddings in that event only, return the matches, and discard the selfie.' },
  { title: 'Photo downloaded', body: 'Photos are served through a short-lived signed URL. The URL works for the duration of the event and never points to any other event.' },
  { title: 'Event ends', body: 'When the retention window expires or the organizer deletes the event, every photo, thumbnail, face embedding, and database record tied to that event is purged. There is no backup we keep.' },
]
  ...
  },
  {
    ...
    body: (
      <p>
        ...
        <a href="mailto:support@picur.my" style={{ color: LUMIERE.accent, borderBottom: `1px solid ${LUMIERE.accent}55`, textDecoration: 'none' }}>support@picur.my</a>{' '}
  ...
  return (
    <LumiereLayout>
      <Head>
        ...
        <meta
          name="description"
          content="How PicUr stores your photos, handles face recognition data, and protects your event galleries."
        />
      </Head>

      <style>{`
        .lumiere-sec-h1 { font-size: clamp(40px, 7vw, 88px); line-height: 0.95; letter-spacing: -0.02em; }
      `}</style>

      {/* HERO */}
      <section className="px-6 sm:px-10 lg:px-14 py-16 lg:py-24 text-center">
        <div className="max-w-[1100px] mx-auto">
          ...
          <h1
            className="lumiere-sec-h1"
            style={{ fontFamily: t.displayFont, fontWeight: 400, margin: 0, color: t.ink }}
          >
            Your photos. <span style={{ fontStyle: 'italic', color: t.accent }}>Yours alone.</span>
          </h1>
          <p
            className="mx-auto"
            style={{
      ...
      {/* ENCRYPTION */}
      <section className="px-6 sm:px-10 lg:px-14 py-12 lg:py-16">
      ...
      {/* LIFECYCLE */}
      <section
        className="px-6 sm:px-10 lg:px-14 py-16 lg:py-24"
      ...
      >
        <div className="max-w-[1100px] mx-auto">
          ...
          />
          <div style={{ borderTop: `1px solid ${t.accent}55` }}>
      ...
      <section className="px-6 sm:px-10 lg:px-14 pb-20 lg:pb-28">
        ...
        >
          ...
          >
            ...
            <span style={{ fontStyle: 'italic', color: t.accent }}>worries you?</span>
          </h2>
          <p
            style={{
              fontFamily: t.bodyFont,
