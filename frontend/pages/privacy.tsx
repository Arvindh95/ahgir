...
export default function PrivacyPolicy() {
  ...
  return (
    <AtelierLayout>
      ...
      <style>{`
        .atelier-legal-h1 { font-size: clamp(40px, 7vw, 88px); line-height: 0.95; letter-spacing: -0.02em; }
        .atelier-legal h2 {
        ...
        .atelier-legal p { margin: 0 0 14px; }
        .atelier-legal ul {
          list-style: none;
          padding: 0;
          margin: 0 0 14px;
        ...
        .atelier-legal a {
          ...
          border-bottom: 1px solid ${t.accent}66;
        }
        .atelier-legal strong, .atelier-legal .em {
          color: ${t.ink};
          font-weight: 600;
        }
      `}</style>
      ...
      <section className="px-6 sm:px-10 lg:px-16 pb-20 lg:pb-28">
        <div
          className="atelier-legal max-w-[860px] mx-auto"
          style={{
